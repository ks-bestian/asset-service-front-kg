...
const searchNm = ref('')
const searchUrl = ref('')
const stDt = ref(new Date().toISOString().split('T')[0])
const edDt = ref(new Date().toISOString().split('T')[0])
...
const fnSearch = () => {
    ...
    store.API_LIST('/api/admin/billHist', param).then((data) => {
...
const fnReset = () => {
    searchNm.value = ''
    searchUrl.value = ''
    stDt.value = new Date().toISOString().split('T')[0]
    edDt.value = new Date().toISOString().split('T')[0]
}
        ...
        <div class="content_section">
            <div class="board_search">
                <div class="search_inner">
                    <div class="form_row">
                        ...
                        <div class="input_item">
                            <label class="form_label">{{ t('10102') }}</label><!--date-->
            ...
            <div class="v_table table_list">
                <DataTable :value="list" paginator :rows="10" :rowsPerPageOptions="[5, 10, 20, 50]"
                    ...
                    :pt="{ pcPaginator: {}, }">
                    <Column field="memberNm" :header="t('10377')" style="width: 7.8%;" class="text_center" sortable>
                    </Column>
                    <Column field="regId" :header="t('10324')" style="width: 10%;" class="text_center" sortable>
                    </Column>
                    <Column field="reqUrl" :header="t('10381')" style="width: 14%;" class="text_center"></Column>
                    <Column field="acsIp" :header="t('10379')" style="width: 10.4%;" class="text_center"></Column>
