...
const fnExcelDownload = () => {
    ...
    const title = t('10028') + t('10084')//"Notice list";
    ...
    <div class="content_inner">
        ...
        <div class="content_section">
            ...
            <div class="v_table table_list">
                <DataTable :value="list" paginator :rows="rows" v-model:first="firstIndex" :rowsPerPageOptions="[5, 10, 20, 50]" @page="fnPage" 
                    tableStyle="min-width: 50rem;" @row-dblclick="fnDetail" paginatorTemplate="RowsPerPageDropdown FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink">
                    <Column field="brdSj" :header="t('10049')" sortable>
                    <template #body="{ data }">
                        <span class="pi pi-thumbtack" v-if="data.importantYn == 'Y'" style="margin-right: 5px;"></span>{{ data.brdSj }}
                    </template>
                    </Column>
                    ...
                    <Column field="notiInqCnt" :header="t('10350')" style="width: 8%;" class="text_center">
                    </Column>
                    <template #empty>
                        <div class="no_data">
