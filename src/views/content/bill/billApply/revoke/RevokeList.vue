...
const fnExcelDownload = () => {
    ...
    const selectedHeaders = ["sclDscRcpNmb", "billName", "ppsrNm", "regDate", "regDt2"];
    const wsCols = [t('10147'), t('10049'), t('10106'), t('10100'), t('10056')]; // Heather name array


    const title = t('10574') + t('10084') //"List of the agenda";
...
/** Detailed screen movement */
const fnGoDetail = (e) => {
    router.push({name: 'bill.revoke.dtl', query: { id: e.data.billId }});
}
