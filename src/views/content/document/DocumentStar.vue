...
const reloadFolder = () => {
    ...
    DocumentService.getStarFiles(title, regNm).then(ff => {
        documents.value = ff;
...
const updateFile = (file) => {
    ...
    fileUpdateModal.value.folderNm = file.folderNm || (file.deptFileYn == 'Y' ? DEPT_ROOT_FOLDER_NM : MY_ROOT_FOLDER_NM);
}
...
<template>
    <DocumentMng :doc-kind="'star'" :file-list="documentsFiltered"
    ...
    <FileUploadModal v-if="fileUploadModal.open" :folder-id="-1" :dialog="fileUploadModal.open"
