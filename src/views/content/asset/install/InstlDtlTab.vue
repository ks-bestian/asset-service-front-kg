            ...
            <template v-for="(item, index) in slotProps.items" :key="index">
                <div class="flex_container m_5">
                    ...
                    <div class="text_container m2">
                        ...
                        <div class="text_lg m_2"><span class="info_text">{{ t('10099') }}</span>{{ lang === 'lng_type_1'
                            ? item.regNm1 : item.regNm2 }}</div>
                        <div class="text_lg m_2"><span class="info_text">{{ t('10738') }}</span>{{ item.instlYmd }}
                        </div>
            ...
            <div style="display: flex; flex-wrap: wrap; justify-content: flex-start; gap: 16px; " class="mb_3">
                <div v-for="(item, j) in slotProps.items" :key="j" class="col_class v_box mt_3">
                    ...
                    <div class="text_xl text_bold m_2">
                        {{ `[${lang === 'lng_type_1' ? item.instlPlcNm1 : lang === 'lng_type_2' ? item.instlPlcNm2 :
                            item.instlPlcNm3}]
                        ${lang === 'lng_type_1' ? item.instlPlcDtl1 : lang === 'lng_type_2' ? item.instlPlcDtl2 :
                                item.instlPlcDtl3}` }}
                    </div>
                    <div class="text_lg m_2"><span class="info_text">{{ t('10099') }}</span>{{ lang === 'lng_type_1' ?
                        item.regNm1 : item.regNm2 }}</div>
