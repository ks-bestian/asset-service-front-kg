...
const fnBillDetail = (e) => {
	router.push({ name: 'billMng.legalActMng.billMngDtl', query: { id: e.data.billId, taskId: e.data.taskId } });
};
...
const fnExcelDownload = () => {
	...
	const title = t('10227') + t('10084')//'List of verification of plenary sessions';
		...
		<div class="content_section">
			...
			<div class="v_table table_list">
				<DataTable :value="tableDatas1" @row-dblclick="fnBillDetail" paginator :rows="10" :pageLinkSize="10" :rowClass="getRowClass"
					...
					<Column field="ppsrNm" :header="t('10106')" style="width: 20%;" class="text_center"></Column>
