...
const fnBillDetail = (e) => {
	router.push({ name: 'billMng.gvrnTrsfMng.billMngDtl', query: { id: e.data.billId, taskId: e.data.taskId } });
};

const fnExcelDownload = () => {
	// Header designation to include

	const selectedHeaders = ["billName", "ppsrNm", "ppslDt", "statNm", "taskStatus"];
	const wsCols = [t('10049'), t('10106'), t('10051'), t('10107'), t('10203')];
	const title = t('10047') + t('10084')//'Government transfer list';
		...
		<div class="content_section">
			...
			<div class="v_table table_list">
				<DataTable :value="tableDatas1" @row-dblclick="fnBillDetail" paginator :rows="10" :pageLinkSize="10" :rowClass="getRowClass"
					...
					<Column field="billNo" :header="t('10292')" style="width: 15%;" class="text_center" sortable></Column>
