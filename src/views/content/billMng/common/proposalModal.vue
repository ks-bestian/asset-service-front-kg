...
<template>
	<Dialog v-model:visible="visible" modal :style="{ width: '65vw', height: '60vh'}" @hide="emit('close')">
		<template #header>
			<div class="popup_header" style="width: 100%; border-top-left-radius: 12px;">
				<h2 class="popup_tit">{{ t('10151') }}</h2><!--List-->
			</div>
		</template>
		<div class="popup_inner">
			<div class="popup_body">
				<div class="popup_cont">
					<div class="v_table table_list type2">
						<DataTable 
							...
							<Column field="polyNm" :header="t('10073')" style="width: 60%;" class="text_center" />
				...
				<div class="popup_footer">
					<div class="btn_group">
						<button type="button" class="v_btn btn_outline_neutral btn_md" @click="emit('close')">{{ t('10153') }}</button><!--close-->
					</div>
				</div>
			</div>
		</div>
