				...
				<div class="v_table" style="height: 10px;"> 
					...
					<div class="v_table"> 
						<DataTable :value="agendaList" >
							...
							<template #body="{data}">
								<button type="button" class="v_btn btn_outline_primary btn_xs" @click="fnBillModal(data.billId)">{{ data.billNo }}</button>
								<!-- <span @click="fnBillModal">{{ data.billNo }}</span> -->
							</template>
							</Column>
