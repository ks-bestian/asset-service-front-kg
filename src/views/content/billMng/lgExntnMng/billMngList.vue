...
const fnBillDetail = (e) => {
	router.push({ name: 'billMng.lgExntnMng.billMngDtl', query: { id: e.data.billId, taskId: e.data.taskId } });
};
...
const fnExcelDownload = () => {
	...
	const wsCols = [t('10293'), t('10106'), t('10051'), t('10107'), t('10203')];

	const title = t('10208') + t('10084') //'List of Law Review';
