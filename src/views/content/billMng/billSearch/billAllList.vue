...
const fnGoDetail = (e) => {
	router.push({ name: 'billMng.billSearch.billAllList.dtl', params: { billId: e.data.billId } });
}

const fnExcelDownload = () => {
	// Header designation to include

	const selectedHeaders = ["naTermCd", "billNo", "billName", "ppsrNm", "ppslDt", "statNm"];
	const wsCols = [t('10116'), t('10292'), t('10293'), t('10106'), t('10051'), t('10056')];

	const title = t('10522') + t('10084')//`` List of End Information '';


	const formattedList = list.value.map(item => ({
		...item,
		...
		<div class="content_section">
			<div class="board_search"><!-- If you go over 2 lines of search items.Type2 -->
				...
				<div class="search_btn">
					<button type="button" class="v_btn btn_primary btn_md" @click="fnGetAgendaList"><i
			...
			<div class="v_table table_list">
				<DataTable :value="list" @row-dblclick="fnGoDetail" paginator :rows="10" :pageLinkSize="10"
					:rowsPerPageOptions="[5, 10, 20, 50]"
					paginatorTemplate="RowsPerPageDropdown FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink">
					<Column field="naTermCd" :header="t('10116')" style="width: 5.8%;" bodyStyle="text-align: center;" sortable></Column>
					<Column field="billNo" :header="t('10292')" style="width: 7.8%;" bodyStyle="text-align: center;" sortable></Column>
					<Column field="billName" :header="t('10293')" sortable></Column>
					<Column field="ppsrNm" :header="t('10106')" style="width: 21.5%;" bodyStyle="text-align: center;" sortable></Column>
					<Column field="ppslDt" :header="t('10051')" style="width: 10.4%;" bodyStyle="text-align: center;" sortable>
						<template #body="slotProps">
							{{ dayjs(slotProps.data.ppslDt, "YYYYMMDD").format("DD/MM/YYYY") }}
						</template>
					</Column>
					<Column field="statNm" :header="t('10056')" style="width: 16.9%;" bodyStyle="text-align: center;" sortable></Column>
				</DataTable>
			</div>
		</div>
		<!-- // Main area -->
