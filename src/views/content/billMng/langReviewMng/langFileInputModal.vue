...
const files = ref();
const myFiles = ref();
const rmrkKg = ref(props.langReview?.rmrkKg);
const rmrkRu = ref(props.langReview?.rmrkRu);
const ebsfileList = ref(props.langReview?.ebsfileList);
const isPublic = ref(false);

const FILE_KIND_CD = '200'; // Language partial opinion
...
const fnSave = () => {
	...
	formData.append("clsCd","120");

	// formData.append("fileKindCd","200");
	...
	if(props.langReview?.seq !== undefined) {
		formData.append("seq", props.langReview?.seq);
	}
