...
const fnBillDetail = (e) => {
	router.push({ name: 'billMng.langReviewMng.billMngDtl', query: { id: e.data.billId, taskId: e.data.taskId } });
};
...
const fnExcelDownload = () => {
	...
	const title = t('10206') + t('10084')//List of language professional opinions;
